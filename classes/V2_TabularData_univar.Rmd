...
# boxplots do not use frequency tables. The middle two box each represents the 25% left to the midian sample and 25% right to the median sample. The left area to the box means the bottom 25% 
# The y-axes means nothing here, only th4e distance of the x-axes mean the acutal percentage
...
# keeping strategy 2: 
meanValues=tapply(eduwa$Student.Teacher.Ratio, eduwa$County, mean,na.rm=T)
